...
%\newcommand{\bitbucketTeam}{\texttt{xpacc-dev}}
%\newcommand{\teamEmail}{\url{xpacc-dev@listserv.illinois.edu}}
...
\vspace{1em}
\begin{tikzpicture}
\node[draw, fill = gray!10,text width=0.9\textwidth] at (0,0) {\code{git clone https://yourBitbucketName@bitbucket.org/jcaps/jcode.git -b $<$branch name$>$}};
\end{tikzpicture}
\vspace{1em}\\
%\\\\
%\noindent\code{git clone https://yourBitbucketName@bitbucket.org/jcaps/jcode.git -b $<$branch name$>$}
%\\\\
