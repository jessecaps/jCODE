...
end module el_ibm_scalar


subroutine el_ibm_scalar_grid
...
end subroutine el_ibm_scalar_grid


subroutine el_ibm_scalar_data
  ...
  do k = iStart(3), iEnd(3)
     do j = iStart(2), iEnd(2)
        do i = iStart(1), iEnd(1)
           ...
           ! Set the density, pressure, and scalar
           if (x.le.x0) then
              density = rho1
              pressure = p1
              velocity = u1
           ...
           conservedVariables(grid_index(i,j,k), nDimensions+3) = density * scalar
        end do
     end do
  end do

  return
end subroutine el_ibm_scalar_data


subroutine el_ibm_scalar_objects
  ...
  return
end subroutine el_ibm_scalar_objects

subroutine el_ibm_scalar_particles
  ...
  return
end subroutine el_ibm_scalar_particles
